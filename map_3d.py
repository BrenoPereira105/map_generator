...
colors = plt.cm.jet(B.flatten()/float(B.max()))

x = np.array([[i] * size_num for i in range(size_num)]).ravel() # x coordinates of each bar
y = np.array([i for i in range(size_num)] * size_num) # y coordinates of each bar
z = np.zeros(size_num*size_num) # z coordinates of each bar
dx = np.ones(size_num*size_num) # length along x-axis of each bar
dy = np.ones(size_num*size_num) # length along y-axis of each bar
dz = B.ravel() # length along z-axis of each bar (height)
